...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblOne" runat="server" Text="Are you sure you want to delete this record?"></asp:Label>
        <p>
            <asp:Button ID="btnYes" runat="server" OnClick="btnYes_Click1" Text="Yes" />
